...
export function Countdown() {
  ...
  const CountdownUnit = ({ value, label }: { value: number; label: string }) => (
    <div className="flex flex-col items-center gap-3 sm:gap-4">
      ...
      <div className="relative group">
        {/* Main card */}
        <div className="relative bg-[#003153]/80 backdrop-blur-md rounded-xl sm:rounded-2xl px-3 py-4 sm:px-5 sm:py-5 md:px-6 md:py-6 lg:px-8 lg:py-7 border border-[#E5C9B7]/20 shadow-[0_12px_30px_rgba(0,31,83,0.35)] hover:shadow-[0_16px_38px_rgba(0,31,83,0.45)] transition-all duration-300 hover:border-[#E5C9B7]/30 min-w-[65px] sm:min-w-[75px] md:min-w-[90px] lg:min-w-[100px]">
          {/* Counter */}
          <div className="relative z-10 flex items-center justify-center">
            <Counter
              ...
              horizontalPadding={4}
              gradientHeight={10}
              gradientFrom="rgba(251,241,231,0.1)"
      ...
      <div className="flex flex-col items-center text-center gap-1">
        <span className={`${playfair.className} text-base sm:text-lg text-[#FBF1E7] tracking-[0.25em] uppercase`}>
          {label}
        </span>
        <span className="text-[10px] sm:text-xs tracking-[0.45em] uppercase text-[#E5C9B7]/70">
  ...
  return (
    <Section
      id="countdown"
      className="relative bg-[#001F3F] py-16 sm:py-20 md:py-24 lg:py-28 overflow-hidden"
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-30">
        ...
        <div 
          ...
          style={{
            backgroundImage: `
              repeating-linear-gradient(45deg, transparent, transparent 70px, rgba(229,201,183,0.1) 70px, rgba(229,201,183,0.1) 71px),
              repeating-linear-gradient(-45deg, transparent, transparent 70px, rgba(229,201,183,0.1) 70px, rgba(229,201,183,0.1) 71px),
              repeating-linear-gradient(135deg, transparent, transparent 35px, rgba(229,201,183,0.08) 35px, rgba(229,201,183,0.08) 36px),
              repeating-linear-gradient(225deg, transparent, transparent 35px, rgba(229,201,183,0.08) 35px, rgba(229,201,183,0.08) 36px)
            `,
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#001F3F]/80 via-transparent to-[#003153]/80" />
      </div>

      {/* Header */}
      <div className="relative z-10 text-center mb-10 sm:mb-12 md:mb-16 px-4">
        <p className="text-xs sm:text-sm md:text-base tracking-[0.45em] uppercase text-[#E5C9B7]/70 mb-3">
          Sapphire Evenings Await
        </p>
        <h2
          className={`${greatVibes.className} text-4xl sm:text-5xl md:text-6xl lg:text-[3.8rem] text-[#FBF1E7] mb-3 sm:mb-4 drop-shadow-[0_18px_40px_rgba(0,31,83,0.65)]`}
        >
          Countdown to the Elegant Soirée
        </h2>
        <p className="text-sm sm:text-base md:text-lg text-[#E5C9B7]/85 font-light max-w-2xl mx-auto leading-relaxed">
          Each heartbeat draws us nearer to a night draped in sapphire blue, champagne, and cream—Ena Gerangaya's luminous coming of age.
        </p>
      </div>
          ...
          <div className="max-w-2xl w-full">
            ...
            <div className="text-center mb-8 sm:mb-10 md:mb-12">
              <div className="flex items-center justify-center gap-2 mb-3 sm:mb-4">
                <div className="w-1.5 h-1.5 bg-[#E5C9B7]/70 rounded-full" />
                <div className="w-1 h-1 bg-[#E5C9B7]/60 rounded-full" />
                <div className="w-1.5 h-1.5 bg-[#E5C9B7]/70 rounded-full" />
              </div>

              <p className="text-xs sm:text-sm md:text-base font-medium text-[#FBF1E7] uppercase tracking-[0.25em] sm:tracking-[0.35em] mb-3 sm:mb-4">
            ...
            <div className="text-center mb-8 sm:mb-10 md:mb-12">
              ...
              <div className="mb-4 sm:mb-5 md:mb-6">
                <p
                  className={`${windSong.className} text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-[#FBF1E7] leading-none drop-shadow-[0_10px_35px_rgba(0,31,83,0.65)]`}
                >
              ...
              <div className="flex items-center justify-center gap-3 sm:gap-4 md:gap-6 mb-6 sm:mb-8">
                ...
                <p
                  className="text-7xl sm:text-8xl md:text-9xl lg:text-[10rem] xl:text-[12rem] font-semibold text-[#FBF1E7] leading-none drop-shadow-[0_18px_35px_rgba(0,31,83,0.45)]"
                >
                  {displayDate ? displayDate.toLocaleDateString('en-US', { day: 'numeric' }) : siteConfig.ceremony.date.split(' ')[1]}
                </p>
                
                {/* Vertical divider */}
                <div className="h-16 sm:h-20 md:h-24 lg:h-28 w-px bg-gradient-to-b from-transparent via-[#E5C9B7]/60 to-transparent" />
                
                {/* Year - Elegant and refined */}
                <p className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light text-[#FBF1E7] leading-none tracking-[0.2em] uppercase">
            ...
            <div className="text-center">
              ...
              {/* Time */}
              <div className="text-xs sm:text-sm md:text-base lg:text-lg font-medium text-[#FBF1E7]/85 tracking-[0.4em] uppercase mb-3 sm:mb-4">
